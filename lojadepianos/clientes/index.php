<?php
    ...
    $consulta = mysqli_query($link, $sql) or die ("Falha ao consultar clientes");
...
<body>
    ...
    <table border=1 class="table">
        ...
        <tr>
            ...
            <td><?php echo $dados["cli_aniv"]; ?></td>
            <td>
                <a href="editar.php?codigo=<?php echo $dados['cli_id']?>">
                    <button class="fa fa-pencil"></button>
                </a>
                <a href="excluir.php?codigo=<?php echo $dados ['cli_id']?>"> 
